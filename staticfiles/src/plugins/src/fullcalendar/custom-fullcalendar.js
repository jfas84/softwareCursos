...
//         }
//     }
//     // Configuração do idioma para pt-br
//     var calendarLocale = {
//         timeFormat: 'HH:mm',
//         buttonText: {
//             today: 'Hoje',
...
//         events: 'reservas/obterReservas',
//         locale: 'pt-br', // Define o idioma para português do Brasil
//         ...calendarLocale, // Adiciona as configurações específicas do idioma pt-br
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendarEventsList = [
        // ... (mantenha as configurações de eventos do calendário)
    ]
    ...
    var calendarEventClick = function(info) {
        ...
        if (eventObj.url) {
            ...
            var getModalEventId = eventObj._def.publicId; 
            var getModalEventLevel = eventObj._def.extendedProps['calendar'];
            console.log('Event Clicked:', getModalEventId, getModalEventLevel);
        }
    }
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        customButtons: {} // Adiciona uma opção vazia para evitar a criação automática do botão de adicionar evento
    });
